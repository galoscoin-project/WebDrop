        ...
        <b-tab-item label="Files" v-bind:class="{ noanim: !$store.state.settings.anim }">
          ...
          <b-table
            ...
            <template slot="empty">
              ...
              <center>
                <p>Open <a href="https://jsxc.teststrana.com">WebDrop.Space</a> on your devices to join this room. Devices under the same WiFi/network will auto join the same room.</p>
        ...
        <b-tab-item label="Devices" v-bind:class="{ noanim: !$store.state.settings.anim }">
          ...
          <p v-show="usersCount === 0">
            <center class="content">
              <p>Open <a href="https://jsxc.teststrana.com">WebDrop.Space</a> on your devices and make sure they are connected to the same WiFi/network.</p>
              <p>Do you want to transfer files over internet ?<br/><earth-icon></earth-icon><br/><router-link to="/room">Share Invite Link or Join Room</router-link></p>
            </center>
          </p>
